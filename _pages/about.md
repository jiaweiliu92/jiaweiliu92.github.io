...
- ``ICIC 2026`` [AnySkel: Automatic Rigging for any Skeletal Template](https://link.springer.com/chapter/10.1007/978-981-92-3397-7_49), Changrong Hu, Na Jiang, **Jiawei Liu** 
...
- ``JICN 2025`` [Occlusion-Guided Feature Purification Learning via Reinforced Knowledge Distillation for Occluded Person Re-Identification](https://www.ffspub.com/index.php/jicn/article/view/31), Yufei Zheng, Yong Wu, **Jiawei Liu**, Wenjun Wang, Wenjun Gan
...
- `IEEE TIP 2026` [ForgeryGPT: A Multimodal LLM for Interpretable Image Forgery Detection and Localization](https://arxiv.org/pdf/2410.10238), Fanrui Zhang, **Jiawei Liu**, Jiaying Zhu, Esther Sun, Qiang Zhang, Zheng-Jun Zha
...
- `NeurIPS 2025` [Reliable Lifelong Multimodal Editing: Conflict-Aware Retrieval Meets Multi-Level Guidance](https://openreview.net/pdf?id=hdJXzKZjY9), Qiang Zhang, Fanrui Zhang, **Jiawei Liu**, Ming Hu, Junjun He, Zheng-Jun Zha
