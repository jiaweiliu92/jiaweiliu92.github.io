...
🌟🌟 等的就是你！现招收对科研有热情、具有主动性的本科生参与科研实习。研究方向涵盖Human-Centric Visual Understanding、Multimodal Large Language Model、Embodied AI等。欢迎来自数学、物理、计算机等相关专业背景的同学加入，无论是参与科研实习、申请大创或暑研，还是有意向继续深造，只要愿意踏实投入研究、尽早接触真实科研并积累项目与论文经验，均欢迎通过邮箱联系，并附上个人简历。
