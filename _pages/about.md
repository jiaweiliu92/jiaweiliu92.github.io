...
- *2024 Fall*, <span style="color:#000000;background-color:#DCFFB7"> Graduate Course - Computer Vision (计算机视觉) \[coming soon\] </span>  
- *2025 Spring*, <span style="color:#000000;background-color:#DCFFB7"> Undergraduate Course - Deep Learning Practice (深度学习实践) \[coming soon\] </span> 
